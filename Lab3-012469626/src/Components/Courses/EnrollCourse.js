    ...
    render() {
        ...
        return (
            ...
            {redirectVar}
                <StudentDashboard/>
                <div>
                <input className="searchBar" type="text" placeholder="Search Bar" value={this.state.value} onChange={this.searchData.bind(this)}/>
                </div>
                <div>
                <button type="submit" value="searchValue"  id="searchValue" onClick={this.searchValue.bind(this)}  >Search</button>
                </div>
