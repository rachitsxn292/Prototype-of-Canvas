...
class Createcourse extends Component{
    ...
    {
        this.props.createCourseMutation({
            variables: {
                email: this.state.email,
                courseid: this.state.genre,
                coursename: this.state.authorId,
                coursedept: this.state.coursedept,
                coursedesc: this.state.coursedesc,
                courseroom: this.state.courseroom,
                coursecapcacity: this.state.coursecapcacity,
                waitlistcapcacity: this.state.waitlistcapcacity,
        ...
        return(
            ...
            <h2>Create Course</h2>
                ...
                <div>
                    ...
                    <Link to='/FacultyDashBoard'>Submit</Link></button>
                </div>
                </div>
            </div>
        )
